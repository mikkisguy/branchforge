...
#### Phase 2 (Follow-up): Import/Detection Wizard

A comprehensive import wizard that:

- Scans all RPY files for existing definitions
- Remembers which file each came from
- Asks user: Convert to our system, preserve original structure, or decide manually

This respects existing project conventions while offering the upgrade path to our managed system.
