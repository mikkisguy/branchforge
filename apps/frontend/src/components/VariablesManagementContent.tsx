...
interface VariablesManagementContentProps {
  projectId: string;
  showHeader?: boolean;
}
...
export function VariablesManagementContent({
  projectId,
  showHeader = true,
}: VariablesManagementContentProps) {
  const {
    variables,
    isLoadingVariables,
    variablesError,
    ...
    <div className="space-y-4">
      {showHeader && (
        <div className="space-y-1">
          <h3 className="text-sm font-medium">Variables Management</h3>
