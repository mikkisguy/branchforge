 ...
 *
 * Dialog for managing route configurations for a project.
...
export function RouteConfigDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-2xl w-full max-h-[90vh] p-0 gap-0 flex flex-col">
        {/* Header */}
              ...
              {routes.length === 0 ? (
                <div className="p-8 border border-dashed border-border/30 rounded-md text-center">
                  <p className="text-sm text-muted-foreground mb-4">
                    No routes configured yet. Add your first route to get
                    started.
                  </p>
                    ...
                    >
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div className="space-y-1">
                          ...
                          />
                          <p className="text-xs text-muted-foreground">
                            Prefix for Ren'Py labels (e.g., "hero_" for
                            "hero_01")
                          </p>
                        </div>
