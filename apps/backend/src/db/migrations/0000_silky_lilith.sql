CREATE TYPE "public"."project_type" AS ENUM('ACT_BASED', 'CHAPTER_BASED');--> statement-breakpoint
...
CREATE TYPE "public"."sync_state" AS ENUM('pending', 'in_progress', 'completed', 'failed');--> statement-breakpoint
CREATE TABLE "users" (
...
ALTER TABLE "scenes" ADD CONSTRAINT "scenes_gitlab_file_id_gitlab_files_id_fk" FOREIGN KEY ("gitlab_file_id") REFERENCES "public"."gitlab_files"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "route_configs_project_key_idx" ON "route_configs" USING btree ("project_id","route_key");--> statement-breakpoint
...
CREATE INDEX "scenes_gitlab_file_id_idx" ON "scenes" USING btree ("gitlab_file_id");--> statement-breakpoint
...
CREATE INDEX "scene_lines_scene_sequence_idx" ON "scene_lines" USING btree ("scene_id","sequence");--> statement-breakpoint
